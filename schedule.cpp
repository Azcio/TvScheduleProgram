...
void scheduleManager::DailySchedule(const string& EnterFile) {
...
void scheduleManager::DailySchedule2(const string& EnterFile) {
    vector<ProgrammeSchedule> schedules = parseData(EnterFile);
...
void scheduleManager::DailySchedule3(const string& EnterFile) {
    vector<ProgrammeSchedule> schedules = parseData(EnterFile);
...
void scheduleManager::DailySchedule4(const string& EnterFile) {
    vector<ProgrammeSchedule> schedules = parseData(EnterFile);
...
void scheduleManager::DailySchedule5(const string& EnterFile) {
    vector<ProgrammeSchedule> schedules = parseData(EnterFile);
...
void scheduleManager::DailySchedule6(const string& EnterFile) {
    vector<ProgrammeSchedule> schedules = parseData(EnterFile);
